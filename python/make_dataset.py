...
if __name__ == "__main__":
    ...
    for time in range(track.time_stamp_ms_first , track.time_stamp_ms_last , 100):
        motion_state = track.motion_states[time]
        assert isinstance(motion_state, dataset_types.MotionState)
        print("Its motion state is " + str(motion_state))
